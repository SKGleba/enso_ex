...
static int (*get_hwcfg)(uint32_t *cfgs) = (void *)0x510128ad;

#define NSKBL_EXPORTS_ADDR (0x51027614)

#define PSP2BOOTCONFIG_STRING (0x51023bb8)
#define PSP2BCFG_STRING_ADDR (0x51023c08)

static int (*self_auth_header)() = (void*)0x51016d69;
static int (*self_setup_authseg)() = (void*)0x51016e59;
static int (*self_load_block)() = (void*)0x51016e95;
#define SGB_BOFF 0x5101873e
#define SGB_ROFF 0x51018730
